...
//        let btnShowWarning = ZFRippleButton()
//        btnShowWarning.alpha = 0
//        btnShowWarning.setImage(UIImage(named: "phongto"), for: UIControlState())
//        btnShowWarning.setImage(UIImage(named: "phongto"), for: UIControlState.highlighted)
//        btnShowWarning.frame = CGRect(x: 0, y: 0, width: navigationBarHeight, height: navigationBarHeight)
//        btnShowWarning.addTarget(self, action: #selector(BaseViewController.onSlideMenuButtonPressed(_:)), for: UIControlEvents.touchUpInside)
//        let customBarItem1 = UIBarButtonItem(customView: btnShowWarning)
